...
function changeMemeDescription(){
  if(srcIndex == 0){
    document.getElementById("currentImage").alt = "Gerry Scotti Keith Haring - Meme von Paolo Bruzzo";
    ...
    document.getElementById("currentImage").alt = "Loredana Bertè als Hades aus <em>Hercules</em> - Meme von Paolo Bruzzo";
    ...
    document.getElementById("currentImage").alt = "Renaulto Zero - Meme von Paolo Bruzzo";
